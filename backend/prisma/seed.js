...
async function main() {
  try {
      ...
      data: [
        {
          ...
          description:
            "Dedicated to environmental conservation through golf events.",
          featured: true,
        ...
        },
        {
          ...
          description:
            "Supporting underprivileged children through sports education.",
          featured: false,
    ...
    if (!drawResult?.id) {
      throw new Error("DrawResult creation failed");
    }
